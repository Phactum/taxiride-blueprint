    ...
    private static void addSimulationProfiles(
        ...
        try {
            ...
            yamlFiles = ClasspathScanner
                    .allResources("/config/",
                            r -> r.getFilename().endsWith(ModuleSpecificPropertiesConfiguration.YAML_EXTENSTION));
            ...
            yamlFiles
                    ...
                    .map(r -> {
                        ...
                        final var moduleName = ModuleSpecificPropertiesConfiguration.getModuleName(r);
                        if (moduleName == null) {
                            return null;
                        }
                        ...
                        return r
                                ...
                                .substring(moduleName.length() + 1,
                                        r.getFilename().length()
                                                - ModuleSpecificPropertiesConfiguration.YAML_EXTENSTION.length());
                    })
