...
public class BlueprintBackoffJobAcquisitionStrategy extends BackoffJobAcquisitionStrategy {

    private static final Logger logger = LoggerFactory.getLogger(BlueprintBackoffJobAcquisitionStrategy.class);
    ...
    public BlueprintBackoffJobAcquisitionStrategy(final JobExecutor jobExecutor) {
