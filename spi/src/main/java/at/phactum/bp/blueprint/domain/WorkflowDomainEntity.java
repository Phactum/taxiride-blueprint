...
public abstract class WorkflowDomainEntity {
    ...
    /**
     * The unique technical workflow-id generated by the underlying BPMNS.
     */
    ...
    /**
     * The unique technical workflow-id of a root-workflow (super-parent) or null if
     * there is no parent-workflow.
     */
